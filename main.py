...
def generate_message_about_cv(query: str) -> tuple:
...
def load_pdf_files():
    # Load the pdf file
    pdf_paths = glob.glob("Jerome de Dios.pdf")
...
def set_langsmith_environment():
    ...
    os.environ["LANGSMITH_PROJECT"] = "jdedioscv"
...
def get_information(question: str = "What are the skills of Jerome?"):
    return generate_message_about_cv(question)
